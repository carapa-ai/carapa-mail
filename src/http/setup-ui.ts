 ...
 */
export function getSetupPage(options: { allowSignup: boolean; hasToken: boolean; publicHostname: string; smtpPort: number; imapProxyPort: number; mcpPort: number; mcpEnabled: boolean; mcpPublicUrl: string } = { allowSignup: false, hasToken: false, publicHostname: '', smtpPort: 2525, imapProxyPort: 1993, mcpPort: 3466, mcpEnabled: false, mcpPublicUrl: '' }): string {
